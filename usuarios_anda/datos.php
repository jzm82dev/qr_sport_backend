...
{
	$consulta = "SELECT * FROM usuarios_anda WHERE id_usuario = ".intval($_GET["id_usuario"]);
...
<script language="JavaScript">
	...
	function cargarContenido(){ 
		...
		var obj=nuevoAjax();
		obj.open("POST", "usuarios_anda/modifica.php",true);
		...
		reiniciar_titulos();
		var direccion="accion="+document.getElementById('form1').accion.value+"&nombre="+encodeURIComponent(document.getElementById('form1').nombre.value)
