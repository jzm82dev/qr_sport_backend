...
{	
	...
	$consulta = "SELECT * FROM usuarios_anda ";
...
<script language="javascript">
 function borrar(id)
 {
 	if(confirm("�Desea realmente borrar este registro?"))
		location.href="usuarios_anda/modifica.php?modulo=usuarios_anda&accion=borrar&limite=<?php echo $limite;?>&id_usuario="+id;
 }
...
<table width="100%" cellpadding="0" cellspacing="0">
  <tr>
    <td class="titulo_principal" valign="middle" height="25px">
		&nbsp;<img src="imagenes/usuario_titulo.png" style="vertical-align:middle ">&nbsp;Asociación Anda&nbsp;>&nbsp;Listado
	</td>		
					...
					if (mysqli_num_rows($rs_usuario) > 0)
					{
						...
						foreach($rs_usuario as $usuario) {
							...
							if($usuario["id_usuario"]!=1){
									echo "<td style='text-align:center;'><a href='usuarios_anda/modifica.php?id_usuario=".$usuario["id_usuario"]."&accion=cambiar_estado&estado=";
									if($usuario["activo"]==0)
							...
							echo "</a></td>".chr(13);								
							if($usuario["id_usuario"]!=1) {
								echo "<td style='text-align:center; '><a href='fcontenido.php?modulo=usuarios_anda&pagina=datos.php&id_usuario=".$usuario["id_usuario"]."&limite=".$limite."'><img src='imagenes/modificar.png' border='0' alt='Modificar' title='Modificar'></a></td>".chr(13);				
