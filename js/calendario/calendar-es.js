...
Calendar._TT["ABOUT"] =
"Seleccion de fecha:\n" +
"- Use los botones \xab, \xbb para seleccionar el anno\n" +
...
"- o haga clic y arrastre el ratón para una selecci&oacute;n m&aacute;s r&aacute;pida.";

Calendar._TT["PREV_YEAR"] = "Anno anterior (mantener para menu)";
Calendar._TT["PREV_MONTH"] = "Mes anterior (mantener para menu)";
Calendar._TT["GO_TODAY"] = "Ir a hoy";
Calendar._TT["NEXT_MONTH"] = "Mes siguiente (mantener para menu;)";
Calendar._TT["NEXT_YEAR"] = "Anno siguiente (mantener para menu;)";
...
Calendar._TT["DAY_FIRST"] = "Hacer %s 1er dia de la semana";
