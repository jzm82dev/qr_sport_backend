...
function Datepicker() {
	...
	this.regional[''] = { // Default regional settings
		...
		monthNamesShort: ['Ene', 'Feb', 'Mar', 'Abr', 'May', 'Jun', 'Jul', 'Agst', 'Sep', 'Oct', 'Nov', 'Dic'], // For formatting
		dayNames: ['Domingo', 'Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sabado'], // For formatting
		dayNamesShort: ['D', 'L', 'M', 'Mi', 'J', 'V', 'S'], // For formatting
		dayNamesMin: ['D','L','M','Mi','J','V','S'], // Column headings for days starting at Sunday
